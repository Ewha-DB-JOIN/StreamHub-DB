...
| REQ9 | DELETE 메뉴 2개 (사용자 입력) | 박나림 | ⬜ |
| REQ10 | PreparedStatement 사용 (사용자 입력 시) | - | ⬜ |
| REQ11 | 스키마에 뷰 + 인덱스 포함 | - | ⬜ |
| REQ12 | UPDATE 트랜잭션 처리 | 신우림 | ⬜ |
...
| 이름 | 담당 REQ | 담당 테이블 |
|------|----------|------------|
| 신우림 (PM) | REQ1, REQ2, REQ3, REQ11, REQ13 | `price_history` — 스키마 통합·검수, 뷰/인덱스, 보고서 취합 |
...
| 날짜 | 마일스톤 | 담당 |
|------|---------|------|
| 5/18 ~ 5/23 | ERD 초안 확정, 테이블별 컬럼 상세 확정 | 전원 |
| 5/24 ~ 5/29 | 제안서 작성 및 검토 | 전원 |
| **2025-05-30** | **제안서 제출** | 신우림 |
| 6/01 ~ 6/05 | SQL 작성 (createschema, initdata — 각자 담당 테이블) | 전원 |
